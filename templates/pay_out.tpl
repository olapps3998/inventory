			...
			<div class="row">
				...
				<section class="col-lg-12 connectedSortable">
					...
					<div class="box box-primary">
							...
							<div class="box-body">
								...
								<table cellpadding="3" cellspacing="3" width="100%">
									<tr>
										...
										<td width="5">:</td>
										<td><input type="hidden" id="paymentNo" name="paymentNo" value="{$payOutNo}">
											<input type="text" id="paymentNo" name="paymentNo" value="{$payOutNo}" class="form-control" placeholder="NOMOR PAYMENT" style="width: 110px; float: left" DISABLED>
											<input type="text" id="paymentDate" name="paymentDate" value="{$payOutDate}" class="form-control" placeholder="Tanggal Payment" style="width: 190px;" required>
										</td>
									</tr>
									<tr valign="top">
										<td>NOMOR FAKTUR</td>
									...
									<tr valign="top">
										<td>TERHUTANG</td>
										<td>:</td>
										<td><input type="text" id="receive" name="receive" value="{$receive}" class="form-control" placeholder="Total Piutang" style="width: 300px;" DISABLED></td>
									</tr>
									<tr>
										<td>DIBAYARKAN KEPADA</td>
										<td>:</td>
										<td>
											<input type="text" id="customerName" name="customerName" value="{$customerName}" class="form-control" placeholder="Nama Customerr" style="width: 300px;" DISABLED>
										</td>
									</tr>
									<tr>
										<td>PEMBAYARAN</td>
						...
						{elseif $module == 'payout' AND $act == 'finish'}
							{literal}
								<script>
									window.location.hash="no-back-button";
									window.location.hash="Again-No-back-button";//again because google chrome don't insert first hash into history
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="print_unit_payout.php?module=payout&act=print&invoiceNo={$invoiceNo}&paymentNo={$paymentNo}&paymentID={$paymentID}" target="_blank"><button class="btn btn-default pull-right">Print</button></a>
						...
						{elseif $module == 'payout' AND $act == 'detailpayout'}
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="print_unit_payout.php?module=payout&act=print&invoiceNo={$invoiceNo}&paymentNo={$paymentNo}&paymentID={$paymentID}" target="_blank"><button class="btn btn-default pull-right">Print</button></a>
										{if $q != ''}
											<a href="pay_out.php?module=payout&act=search&q={$q}"><button class="btn btn-default pull-right">Back</button></a>
										{else}
											<a href="pay_out.php?page={$page}"><button class="btn btn-default pull-right">Back</button></a>
										{/if}
									</div>
								</div>
							</div><!-- /.box-header -->
						...
						{elseif $module == 'payout' AND $act == 'search'}
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										...
										<form method="GET" action="pay_out.php">
											...
											<a href="print_pay_out_excel.php?f=pay_out&act=print&q={$q}&startDate={$startDate}&endDate={$endDate}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-file-o"></i> Excel</button></a>
											<a href="print_pay_out.php?act=print&q={$q}&startDate={$startDate}&endDate={$endDate}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print PDF</button></a>
											&nbsp;&nbsp;&nbsp;
										</form>
									</div>
								</div>
										...
										<tbody>
											{section name=dataPay loop=$dataPay}
												<tr>
													...
													<td>
														<a title="Detail" href="pay_out.php?module=payout&act=detailpayout&paymentID={$dataPay[dataPay].paymentID}&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&q={$q}&page={$page}"><img src="img/icons/view.png" width="18"></a>
														<a title="Delete" href="pay_out.php?module=payout&act=delete&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&paymentID={$dataPay[dataPay].paymentID}&q={$q}" onclick="return confirm('Anda Yakin ingin membatalkan nomor pembayaran {$dataPay[dataPay].paymentNo}? penghapusan ini akan membatalkan pembayaran transaksi ini.');"><img src="img/icons/delete.png" width="18"></a>
													</td>
												</tr>
											{/section}
										</tbody>
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										...
										<form method="GET" action="pay_out.php">
											...
											<a href="pay_out.php?module=payout&act=add" style="float: left;"><button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Add</button></a>
											<a href="print_pay_out_excel.php?f=pay_out&act=print&q={$q}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-file-o"></i> Excel</button></a>
											<a href="print_pay_out.php?act=print&q={$q}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print PDF</button></a>
											&nbsp;&nbsp;&nbsp;
										</form>
									</div>
								</div>
										...
										<tbody>
											{section name=dataPay loop=$dataPay}
												<tr>
													...
													<td>{$dataPay[dataPay].staffName}</td>
													<td>
														<a title="Detail" href="pay_out.php?module=payout&act=detailpayout&paymentID={$dataPay[dataPay].paymentID}&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&page={$page}"><img src="img/icons/view.png" width="18"></a>
