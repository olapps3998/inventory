							...
							<div class="box-body">
								...
								<table cellpadding="3" cellspacing="3">
									...
									<tr valign="top">
										<td>NO INVOICE</td>
										<td>:</td>
										<td><input type="text" id="invoiceNo" name="invoiceNo" value="{$invoiceNo}" class="form-control" placeholder="Nomor Invoice" style="width: 270px;" required>
											{if $numsBBuy == '0' AND $invoiceNo != ''}
									...
									<tr>
										<td>SUPPLIER</td>
										<td>:</td>
										<td><input type="text" id="supplier" name="supplier" value="{$supplierName}" class="form-control" placeholder="Supplier" style="width: 270px;" DISABLED></td>
									</tr>
									<tr>
										<td>CARA RETUR</td>
										<td>:</td>
									...
									<tr>
										...
										<td><select id="ppnType" name="ppnType" class="form-control" style="width: 100px; float: left;" required>
												<option value=""></option>
												<option value="1" {if $ppnType == '1'} SELECTED {/if}>PPN</option>
												<option value="2" {if $ppnType == '2'} SELECTED {/if}>NO PPN</option>
											</select>
										</td>
									</tr>
									<tr>
											...
											{if $numsBBuy > 0}
												{section name=dataBbmDetail loop=$dataBbmDetail}
													<tr>
														...
														<td>{$dataBbmDetail[dataBbmDetail].factoryName} <input type="hidden" name="factoryID[]" value="{$dataBbmDetail[dataBbmDetail].factoryID}"> <input type="hidden" name="factoryName[]" value="{$dataBbmDetail[dataBbmDetail].factoryName}"></td>
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										...
										<form method="GET" action="retur_suppliers.php">
											...
											<a href="print_returbuy_excel.php?f=returbuy&act=print&q={$q}&startDate={$startDate}&endDate={$endDate}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-file-o"></i> Excel</button></a>
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										...
										<form method="GET" action="retur_suppliers.php">
											...
											<input type="text" value="{$q}" id="q" name="q" class="form-control" placeholder="Pencarian : Nomor Retur Pembelian" style="float: right; width: 270px;">
											<a href="retur_suppliers.php?module=returbuy&act=add" style="float: left;"><button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Add</button></a>
											<a href="print_returbuy_excel.php?f=returbuy&act=print&q={$q}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-file-o"></i> Excel</button></a>
