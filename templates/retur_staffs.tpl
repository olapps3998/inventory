							...
							<div class="box-body">
								...
								<table cellpadding="3" cellspacing="3">
									...
									<tr>
										<td>CUSTOMER</td>
										<td>:</td>
										<td><input type="text" id="customer" name="customer" value="{$customerName}" class="form-control" placeholder="Customer" style="width: 270px;" DISABLED></td>
									</tr>
									<tr>
										<td>CARA RETUR</td>
										<td>:</td>
										...
										<tbody>
											{if $numsBSale > 0}
												{section name=dataDoDetail loop=$dataDoDetail}
													<tr>
														<td>{$dataDoDetail[dataDoDetail].no} <input type="hidden" name="detailID[]" value="{$dataDoDetail[dataDoDetail].detailID}"></td>
														<td>{$dataDoDetail[dataDoDetail].factoryName} <input type="hidden" name="factoryID[]" value="{$dataDoDetail[dataDoDetail].factoryID}"> <input type="hidden" name="factoryName[]" value="{$dataDoDetail[dataDoDetail].factoryName}"></td>
