				...
				<table cellpadding="7" cellspacing="7">
					...
					<tr valign="top">
						...
						<td> 	<input type="checkbox" id="authorize1" name="authorize1" {if $adm == '1'} CHECKED {/if}> Administrator <br>
								...
								<input type="checkbox" id="authorize4" name="authorize4" {if $spv == '4'} CHECKED {/if}> Spv <br>
								<input type="checkbox" id="authorize5" name="authorize5" {if $top == '5'} CHECKED {/if}> Top <br>
						</td>
					</tr>
				</table>
