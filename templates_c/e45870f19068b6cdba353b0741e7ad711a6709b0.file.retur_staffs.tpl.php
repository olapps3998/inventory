<?php /* Smarty version Smarty-3.1.11, created on 2017-09-05 11:01:42
         compiled from ".\templates\retur_staffs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2066059ae20e548cb44-84473415%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e45870f19068b6cdba353b0741e7ad711a6709b0' => 
    array (
      0 => '.\\templates\\retur_staffs.tpl',
      1 => 1504584012,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2066059ae20e548cb44-84473415',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_59ae20e56447d3_22137264',
  'variables' => 
  array (
    'module' => 0,
    'act' => 0,
...
<?php if ($_valid && !is_callable('content_59ae20e56447d3_22137264')) {function content_59ae20e56447d3_22137264($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
			...
			<div class="row">
				...
				<section class="col-lg-12 connectedSortable">
					...
					<div class="box box-primary">
						...
						<?php if ($_smarty_tpl->tpl_vars['module']->value=='retursale'&&$_smarty_tpl->tpl_vars['act']->value=='add'){?>
...
" class="form-control" placeholder="Tanggal Retur Penjualan" style="width: 160px;" required>
										</td>
									</tr>
									<tr valign="top">
										<td>NO INVOICE</td>
...
" class="form-control" placeholder="Nomor Invoice" style="width: 270px;" required>
											<?php if ($_smarty_tpl->tpl_vars['numsBSale']->value=='0'&&$_smarty_tpl->tpl_vars['invoiceNo']->value!=''){?>
												<span style="color: red;">Nomor invoice penjualan tidak ditemukan.</span>
											<?php }?>
										</td>
									</tr>
									<tr>
										<td>CUSTOMER</td>
										<td>:</td>
										<td><input type="text" id="customer" name="customer" value="<?php echo $_smarty_tpl->tpl_vars['customerName']->value;?>
" class="form-control" placeholder="Customer" style="width: 270px;" DISABLED></td>
								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php if ($_smarty_tpl->tpl_vars['numsBSale']->value>0){?>
...
?>
 ...
 <input type="hidden" name="detailID[]" value="<?php echo $_smarty_tpl->tpl_vars['dataDoDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDoDetail']['index']]['detailID'];?>
"></td>
 ...
 <input type="hidden" name="factoryID[]" value="<?php echo $_smarty_tpl->tpl_vars['dataDoDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDoDetail']['index']]['factoryID'];?>
"> <input type="hidden" name="factoryName[]" value="<?php echo $_smarty_tpl->tpl_vars['dataDoDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDoDetail']['index']]['factoryName'];?>
"></td>
 ...
 <input type="hidden" name="productID[]" value="<?php echo $_smarty_tpl->tpl_vars['dataDoDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDoDetail']['index']]['productID'];?>
"> <input type="hidden" name="productName[]" value="<?php echo $_smarty_tpl->tpl_vars['dataDoDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDoDetail']['index']]['productName'];?>
"></td>
 ...
 <input type="hidden" name="unitPrice[]" value="<?php echo $_smarty_tpl->tpl_vars['dataDoDetail']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataDoDetail']['index']]['price'];?>
"></td>
						...
						<?php }elseif($_smarty_tpl->tpl_vars['module']->value=='retursale'&&$_smarty_tpl->tpl_vars['act']->value=='finish'){?>
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="print_unit_retursale.php?module=retursale&act=print&invoiceNo=<?php echo $_smarty_tpl->tpl_vars['invoiceNo']->value;?>
...
?>
						...
						<?php }elseif($_smarty_tpl->tpl_vars['module']->value=='retursale'&&$_smarty_tpl->tpl_vars['act']->value=='detailretur'){?>
...
?>
						...
						<?php }elseif($_smarty_tpl->tpl_vars['module']->value=='retursale'&&$_smarty_tpl->tpl_vars['act']->value=='search'){?>
...
" id="q" name="q" class="form-control" placeholder="Pencarian : Nomor Retur Penjualan" style="float: right; width: 270px;">
											...
											<a href="print_retursale_excel.php?f=retursale&act=print&q=<?php echo $_smarty_tpl->tpl_vars['q']->value;?>
...
" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-file-o"></i> Excel</button></a>
											<a href="print_retursale.php?act=print&q=<?php echo $_smarty_tpl->tpl_vars['q']->value;?>
&startDate=<?php echo $_smarty_tpl->tpl_vars['startDate']->value;?>
&endDate=<?php echo $_smarty_tpl->tpl_vars['endDate']->value;?>
...
?>
												<tr>
													...
													<td><?php echo $_smarty_tpl->tpl_vars['dataRetur']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataRetur']['index']]['customerName'];?>
</td>
													...
													<td>
														<a title="Detail" href="retur_staffs.php?module=retursale&act=detailretur&returID=<?php echo $_smarty_tpl->tpl_vars['dataRetur']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataRetur']['index']]['returID'];?>
...
"><img src="img/icons/view.png" width="18"></a>
														<a title="Delete" href="retur_staffs.php?module=retursale&act=delete&returID=<?php echo $_smarty_tpl->tpl_vars['dataRetur']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataRetur']['index']]['returID'];?>
&returNo=<?php echo $_smarty_tpl->tpl_vars['dataRetur']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataRetur']['index']]['returNo'];?>
&invoiceNo=<?php echo $_smarty_tpl->tpl_vars['dataRetur']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataRetur']['index']]['invoiceNo'];?>
