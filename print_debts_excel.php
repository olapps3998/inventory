	...
	if ($act == 'print')
	{
		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
						...
						<tr valign='top'>
							...
							<td>
								<span style='font-size: 11pt;'><b>KARTU HUTANG</b></span>
							</td>
						</tr>
					</table>
					<br>
					<table cellpadding='0' cellspacing='0' style='width: 240mm; border-bottom: 1px solid #000;'>
						<tr>
							...
							<th style='width: 70mm; padding: 2px 0px 2px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>SUPPLIER</th>
						...
						{
							$total = $dataDebt['debtTotal']; //$total = rupiah($dataDebt['debtTotal']);
							$incomingTotal = $dataDebt['incomingTotal']; //$incomingTotal = rupiah($dataDebt['incomingTotal']);
							$reductionTotal = $dataDebt['reductionTotal']; //$reductionTotal = rupiah($dataDebt['reductionTotal']);
							$sisa = $dataDebt['debtTotal'] - ($dataDebt['incomingTotal'] + $dataDebt['reductionTotal']); //$sisa = rupiah($dataDebt['debtTotal'] - ($dataDebt['incomingTotal'] + $dataDebt['reductionTotal']));
							...
							$content .= "
									<tr valign='top'>
										...
										<td style='padding: 2px 0px 2px 0px; font-size: 9pt;'>$dataDebt[valas]</td>
