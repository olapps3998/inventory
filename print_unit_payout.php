		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
					...
					<table cellpadding='0' cellspacing='0' style='width: 240mm;'>
						<tr>
							...
							<td style='padding: 2px 0px 2px 0px; font-size: 9pt; width: 120mm;'>Kepada Yth :</td>
							<td colspan='2'></td>
						</tr>
						<tr>
							...
							<td style='padding: 2px 0px 2px 0px; font-size: 9pt;' colspan='3'>$dataPay[customerName]</td>
						</tr>
						<tr valign='top'>
							...
							<td style='padding: 2px 0px 2px 0px; font-size: 9pt;' colspan='3' rowspan='3'>$dataPay[customerAddress]</td>
						</tr>
						<tr>
